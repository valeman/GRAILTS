...
static arrayobject *__pyx_v_5hello_a = 0;
static __Pyx_memviewslice __pyx_v_5hello_ca = { 0, 0, { 0 }, { 0 }, { 0 } };
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "hello._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_global_init_code(void) {
  ...
  /*--- Global init code ---*/
  __pyx_v_5hello_a = ((arrayobject *)Py_None); Py_INCREF(Py_None);
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "hello")) {
      if (unlikely(PyDict_SetItemString(modules, "hello", __pyx_m) < 0)) __PYX_ERR(2, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_XGOTREF(((PyObject *)__pyx_v_5hello_a));
  __Pyx_DECREF_SET(__pyx_v_5hello_a, ((arrayobject *)__pyx_t_1));
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 * hello(&ca[0], 3)
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_5hello_a), PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(2, 8, __pyx_L1_error)
  __PYX_XDEC_MEMVIEW(&__pyx_v_5hello_ca, 1);
  __pyx_v_5hello_ca = __pyx_t_3;
 ...
 * hello(&ca[0], 3)             # <<<<<<<<<<<<<<
 */
  if (unlikely(!__pyx_v_5hello_ca.memview)) { __Pyx_RaiseUnboundLocalError("ca"); __PYX_ERR(2, 10, __pyx_L1_error) }
  __pyx_t_4 = 0;
  __pyx_t_5 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_5hello_ca.shape[0];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_5hello_ca.shape[0])) __pyx_t_5 = 0;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    __PYX_ERR(2, 10, __pyx_L1_error)
  }
  hello((&(*((double *) ( /* dim=0 */ (__pyx_v_5hello_ca.data + __pyx_t_4 * __pyx_v_5hello_ca.strides[0]) )))), 3);
