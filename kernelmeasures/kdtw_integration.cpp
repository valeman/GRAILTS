...
#define __PYX_HAVE__kdtw
#define __PYX_HAVE_API__kdtw
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'kdtw' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static arrayobject *__pyx_v_4kdtw_x = 0;
static arrayobject *__pyx_v_4kdtw_y = 0;
static __Pyx_memviewslice __pyx_v_4kdtw_xa = { 0, 0, { 0 }, { 0 }, { 0 } };
static __Pyx_memviewslice __pyx_v_4kdtw_ya = { 0, 0, { 0 }, { 0 }, { 0 } };
...
#define __Pyx_MODULE_NAME "kdtw"
extern int __pyx_module_is_main_kdtw;
int __pyx_module_is_main_kdtw = 0;

/* Implementation of 'kdtw' */
...
static int __pyx_pymod_exec_kdtw(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_kdtw},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_global_init_code(void) {
  ...
  /*--- Global init code ---*/
  __pyx_v_4kdtw_x = ((arrayobject *)Py_None); Py_INCREF(Py_None);
  __pyx_v_4kdtw_y = ((arrayobject *)Py_None); Py_INCREF(Py_None);
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initkdtw(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initkdtw(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_kdtw(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_kdtw(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_kdtw(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'kdtw' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_kdtw(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kdtw", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "kdtw")) {
      if (unlikely(PyDict_SetItemString(modules, "kdtw", __pyx_m) < 0)) __PYX_ERR(2, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "kdtw_integration.pyx":2
 * from cpython cimport array
 * import array             # <<<<<<<<<<<<<<
 * 
 * cdef extern from "headers.h":
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_array, 0, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_array, __pyx_t_1) < 0) __PYX_ERR(2, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "kdtw_integration.pyx":7
 ...
 */
  ...
  __pyx_t_2 = PyTuple_New(2); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_XGOTREF(((PyObject *)__pyx_v_4kdtw_x));
  __Pyx_DECREF_SET(__pyx_v_4kdtw_x, ((arrayobject *)__pyx_t_1));
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;

  /* "kdtw_integration.pyx":8
 * 
 * cdef array.array x = array.array('d', [1, 2, 3])
 * cdef array.array y = array.array('d', [2,3,4])             # <<<<<<<<<<<<<<
 * 
 * cdef double[:] xa = x
 */
  __pyx_t_1 = PyList_New(3); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_int_2);
  __Pyx_GIVEREF(__pyx_int_2);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_7cpython_5array_array), __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_XGOTREF(((PyObject *)__pyx_v_4kdtw_y));
  __Pyx_DECREF_SET(__pyx_v_4kdtw_y, ((arrayobject *)__pyx_t_1));
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;

  /* "kdtw_integration.pyx":10
 * cdef array.array y = array.array('d', [2,3,4])
 * 
 * cdef double[:] xa = x             # <<<<<<<<<<<<<<
 * cdef double[:] ya  = y
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_4kdtw_x), PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(2, 10, __pyx_L1_error)
  __PYX_XDEC_MEMVIEW(&__pyx_v_4kdtw_xa, 1);
  __pyx_v_4kdtw_xa = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "kdtw_integration.pyx":11
 * 
 * cdef double[:] xa = x
 * cdef double[:] ya  = y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_4kdtw_y), PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(2, 11, __pyx_L1_error)
  __PYX_XDEC_MEMVIEW(&__pyx_v_4kdtw_ya, 1);
  __pyx_v_4kdtw_ya = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "kdtw_integration.pyx":13
 * cdef double[:] ya  = y
 * 
 * print(kdtw(&xa[0], 3, &ya[0], 3, 1))             # <<<<<<<<<<<<<<
 */
  if (unlikely(!__pyx_v_4kdtw_xa.memview)) { __Pyx_RaiseUnboundLocalError("xa"); __PYX_ERR(2, 13, __pyx_L1_error) }
  __pyx_t_4 = 0;
  __pyx_t_5 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_4kdtw_xa.shape[0];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_4kdtw_xa.shape[0])) __pyx_t_5 = 0;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    __PYX_ERR(2, 13, __pyx_L1_error)
  }
  if (unlikely(!__pyx_v_4kdtw_ya.memview)) { __Pyx_RaiseUnboundLocalError("ya"); __PYX_ERR(2, 13, __pyx_L1_error) }
  __pyx_t_6 = 0;
  __pyx_t_5 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_4kdtw_ya.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_4kdtw_ya.shape[0])) __pyx_t_5 = 0;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    __PYX_ERR(2, 13, __pyx_L1_error)
  }
  __pyx_t_1 = PyFloat_FromDouble(kdtw((&(*((double *) ( /* dim=0 */ (__pyx_v_4kdtw_xa.data + __pyx_t_4 * __pyx_v_4kdtw_xa.strides[0]) )))), 3, (&(*((double *) ( /* dim=0 */ (__pyx_v_4kdtw_ya.data + __pyx_t_6 * __pyx_v_4kdtw_ya.strides[0]) )))), 3, 1.0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PrintOne(0, __pyx_t_1) < 0) __PYX_ERR(2, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "kdtw_integration.pyx":1
 * from cpython cimport array             # <<<<<<<<<<<<<<
 * import array
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kdtw", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kdtw");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
